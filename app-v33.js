...
function drawPizzaLogoCenter(ctx, x, y, radius) {
  ...
  ctx.translate(x, y);
  ctx.rotate(-0.25);
  ctx.scale(radius / 52, radius / 52);
  ctx.lineJoin = "round";
  ctx.lineCap = "round";

  ctx.beginPath();
  ctx.moveTo(-36, -24);
  ctx.bezierCurveTo(-14, -39, 22, -40, 38, -27);
  ctx.bezierCurveTo(45, -21, 42, -10, 33, -8);
  ctx.bezierCurveTo(8, -13, -14, -9, -34, 3);
  ctx.bezierCurveTo(-47, 11, -52, -13, -36, -24);
  ctx.fillStyle = "#e88934";
  ctx.fill();
  ...
  ctx.beginPath();
  ctx.moveTo(-31, -4);
  ctx.bezierCurveTo(1, -20, 24, -14, 35, -7);
  ctx.bezierCurveTo(31, 19, 18, 39, 4, 52);
  ctx.bezierCurveTo(-2, 41, -7, 29, -14, 43);
  ctx.bezierCurveTo(-22, 28, -20, 13, -31, 20);
  ctx.bezierCurveTo(-39, 7, -40, 1, -31, -4);
  ...
  [
    ...
    ctx.beginPath();
    ctx.ellipse(cx, cy, 5, 3.2, 0.25, 0, Math.PI * 2);
    ctx.fillStyle = "#ffd36c";
    ctx.fill();
    ctx.strokeStyle = "#9f5520";
    ctx.lineWidth = 2;
    ctx.stroke();
  });
  ...
  [
    ...
    ctx.beginPath();
    ctx.moveTo(cx - 8, cy);
    ctx.bezierCurveTo(cx - 7, cy - 11, cx + 12, cy - 12, cx + 14, cy);
    ctx.bezierCurveTo(cx + 8, cy - 2, cx + 7, cy + 9, cx, cy + 5);
    ctx.bezierCurveTo(cx - 5, cy + 10, cx - 11, cy + 5, cx - 8, cy);
    ctx.fillStyle = "#3c9255";
    ctx.fill();
    ctx.strokeStyle = "#225433";
    ctx.lineWidth = 2.5;
    ctx.stroke();
  });
